        ...
        return (
            <Layout className="containAll">
                <Sider
                    ...
                    { this.state.theme === 'light' ? <span className="author">公司logo</span> : <span className="author white">公司logo</span> }
                    <Menu theme={this.state.theme} mode="inline" defaultSelectedKeys={['1']} className="menu">
                        {
                            allMenu.map((v,i) => {
